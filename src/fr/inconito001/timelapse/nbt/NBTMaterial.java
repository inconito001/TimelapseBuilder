package fr.inconito001.timelapse.nbt;

import org.bukkit.Material;

import fr.inconito001.timelapse.nbt.block.NBTBlock;
import fr.inconito001.timelapse.nbt.block.NBTChestBlock;
import fr.inconito001.timelapse.nbt.block.NBTSignBlock;
...
public enum NBTMaterial {
    ...
    TRAPPED_CHEST(false, NBTChestBlock.class),
    ...
    public static NBTMaterial fromTag(NBTTagCompound nbtTagCompound) {
        try {
            return NBTMaterial.valueOf(nbtTagCompound.getString("id").replace("minecraft:", "").toUpperCase());
